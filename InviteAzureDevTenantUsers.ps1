...
###Invite User
New-AzureADMSInvitation -InvitedUserEmailAddress "$DevEmail" -InvitedUserDisplayName "$DevUser (StarRez)" -InviteRedirectUrl "https://www.starrez.com" -SendInvitationMessage $False -InvitedUserType "Guest" 
...
Add-AzureADGroupMember -ObjectId "$AADGroup" -RefObjectId $DevUserObjectID.objectid

# SIG # Begin signature block
# MIIFkQYJKoZIhvcNAQcCoIIFgjCCBX4CAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUR3C3bykFiHcAwP6U8H+rKcjQ
# h4ygggMqMIIDJjCCAg6gAwIBAgIQNYZOqmy96aNMSPkHN4jyKTANBgkqhkiG9w0B
...
# DAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUFA3+DQdqAezDU21uv5KdPD/3
# Z5EwDQYJKoZIhvcNAQEBBQAEggEAu5e+NrLcQBinOKyPUi1Ng659tBytts3C6jv6
# YVJWkwYNuyyE2fcy47n7hqqBNwjbA+STsqGPZpPKrV0c+glegsK8y/+OULj6vA65
# 7i13cTUDO8lNlg+NiPGVBlcKjwuwKvKWKa1sg+v0D6K7QDeEO60xwuWqGOoeZIdI
# Pn22+6lqJP6sixbQ0hB2tDz214MbxgmmDn9Ghp38EQ3B6k6bkN9YHSIiX1yek/gY
# eMEJ7wmJ1Ho6FK7QD/G9VIHtd/Jz91SQ/fkB73nSWKDRJUz6/hxO38wPrbpTZUwb
# ajrJk9TQb78eCh0qRUKCAjJpiV1FMgNlg5KV3gHnrFl45h69cw==
